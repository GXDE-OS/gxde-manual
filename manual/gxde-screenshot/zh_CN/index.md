#  GXDE 截图|../common/deepin-screenshot.svg|

## 概述
 GXDE 截图是武汉深之度科技有限公司开发的深度操作系统下自带的截图工具。在日常工作和娱乐中，为了展示特定状态下的程序界面，应用场景等，需要截取可以显示在屏幕或其他显示设备上的可视图像，您可以通过运行 GXDE 截图软件来实现。

 GXDE 截图拥有模糊和马赛克的图片编辑功能，在传播图片的过程中帮助您保护隐私信息不外泄。
...
* 使用专业的截图软件来截取屏幕，如深度操作系统自带的 GXDE 截图软件。

## 使用入门

### 运行 GXDE 截图
您可以通过执行以下操作之一来运行 GXDE 截图，进入截图模式后，整个电脑屏幕将会变暗。

* 在任务栏上，点击 ![启动器](icon/launcher_icon.svg) 进入启动器界面，通过浏览找到 ![ GXDE 截图](icon/screenshot-24.svg) 点击。

* 按下键盘上的 ![ctrl](icon/Ctrl.svg)+![alt](icon/Alt.svg)+![A](icon/A.svg) 组合键来快速运行 GXDE 截图。
...
> ![attention](icon/attention.svg)：如果您已经将 GXDE 截图固定到任务栏，右键单击任务栏上的 ![ GXDE 截图](icon/screenshot-24.svg)，然后选择 **延时截图** 来延时截取。

您也可以通过操作以下步骤来实现延时截图：

1. 按下键盘上的 ![ctrl](icon/Ctrl.svg)+![print](icon/Print.svg) 组合键。

2. 在屏幕的右上角，您会看到“ GXDE 截图将在5秒后启动”的提示信息。
...
> ![notes](icon/notes.svg)：当电脑多屏显示时，您也可以使用 GXDE 截图来截取不同屏幕上的区域。
...
2. 将鼠标指针移至桌面上， GXDE 截图会自动选中整个屏幕，并在其左上角显示当前截图区域的尺寸大小。
...
* 如果您已经将 GXDE 截图固定到任务栏，右键单击任务栏上的 ![ GXDE 截图](icon/screenshot-24.svg)，然后选择 **截取全屏** 。
...
2. 将鼠标指针移至打开的应用窗口上， GXDE 截图会自动选中该窗口，并在其左上角显示当前截图区域的尺寸大小。
...
## 编辑截图
 ...
 GXDE 截图自带的图片编辑功能，包括图形标记、文字批注等，完全可以满足您的日常图片处理需求。您还可以给图片打上马赛克，保护您的隐私。
...
### 工具栏说明
在截图过程中，您可以点击工具栏上的各个图标以完成各项操作。运行 GXDE 截图，通过鼠标选中截图区域后，工具栏会自动出现在截图的下方。您也可以在截图时使用右键菜单来快速调用工具栏。

> ![attention](icon/attention.svg)：如果您已经对工具栏展开面板，如线条粗细、字体大小等进行了设置， GXDE 截图会记住您的选择。当您下次启动 GXDE 截图后，将默认使用该设置，您也可以重新进行选择。
...
### 设置标记颜色
 GXDE 截图总共提供了16种颜色供您选择，您可以选择不同的颜色来进行不同的图形标记。
