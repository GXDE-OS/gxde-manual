# GXDE Editor|../common/deepin-editor.svg|
...
> ![notes](icon/notes.svg): If you make changes to the file but have not saved it, GXDE Editor will prompt you to save it when closing.
