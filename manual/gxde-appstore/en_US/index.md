# GXDE Store|../common/deepin-appstore.svg|
...
> ![notes](icon/notes.svg): GXDE Store has been fixed on Dock by default, you can click on ![GXDE Store](icon/store-24.svg) on Dock to run it.
