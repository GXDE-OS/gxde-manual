#  GXDE 商店|../common/deepin-appstore.svg|

## 概述
 GXDE 商店是一款集应用展示、下载、安装、卸载、评论、评分、推荐于一体的应用程序。 GXDE 商店为您精心筛选和收录了不同类别的应用，每款应用都经过人工安装并验证。您可以进入商店搜索热门应用，一键下载并自动安装。
...
### 运行 GXDE 商店
您可以通过执行以下操作来运行 GXDE 商店：

1. 点击任务栏上的 ![launcher-24](icon/launcher-24.svg) 进入启动器界面。
2. 通过浏览找到 ![store-24](icon/store-24.svg) 点击。

> ![notes](icon/notes.svg) ： GXDE 商店已经默认固定在任务栏上，您也可以点击任务栏上的 ![store-24](icon/store-24.svg) 。

### 最大/最小化 GXDE 商店

- 在 GXDE 商店界面，点击 ![icon_max](icon/icon_max.svg) 最大化图标， GXDE 商店将窗口最大化显示。如果要恢复正常显示，请点击 ![icon_unmax](icon/icon_unmax.svg) 恢复原始窗口。
- 在 GXDE 商店界面，点击 ![icon_min](icon/icon_min.svg) 最小化图标， GXDE 商店将最小化到任务栏。如果要恢复显示，请点击任务栏上的 ![store-24](icon/store-24.svg) 商店图标。

### 关闭 GXDE 商店

- 在 GXDE 商店界面，点击 ![icon_close](icon/icon_close.svg) 关闭图标，退出 GXDE 商店。
- 右键单击任务栏上的 ![store-24](icon/store-24.svg) 商店图标，选择 **关闭所有** 来退出 GXDE 商店。
- 在 GXDE 商店界面，点击主菜单，选择 [退出](#退出)。


## 主界面
 GXDE 商店主界面由导航栏、搜索框、主菜单、首页轮播、首页栏目、热门专题、下载管理、和卸载应用组成。
...
<table class="block1">
    ...
    <tbody>
        <tr>
            ...
            <td>导航栏主要显示 GXDE 商店的首页、排行榜以及应用分类。</td>
        </tr>
        <tr>
            <td>2</td>
            <td>搜索框</td>
            <td>用户可以通过搜素框快速查找 GXDE 商店中的所有应用。</td>
        </tr>
         <tr>
            <td>3</td>
            <td>主菜单</td>
            <td>通过主菜单您可以推荐应用、清除缓存、切换主题、查看帮助手册、关于信息、退出 GXDE 商店。</td>
        </tr>
        <tr>
            <td>4</td>
            <td>首页轮播区域</td>
...
## 应用管理
您可以通过 GXDE 商店搜索、下载、安装不同分类的应用，同时还可以根据轮播图、最新上架、装机必备、热门推荐、分类推荐、热门专题、下载排行、星级排行、用户评论等不同方式挖掘更多精彩应用。

### 搜索应用
 GXDE 商店中自带搜索功能，您只需在搜索框中输出关键字，将自动在下方显示含该关键字的应用名称。按下键盘上的 ![Enter](icon/Enter.svg) 键，可查看包含该关键字的所有应用。

![1|Search](jpg/search.jpg)

### 下载/安装应用
 GXDE 商店提供一键式的应用下载和安装，无需手动处理，同时在下载安装应用的过程中，您可以暂停、删除等操作，还可以查看当前应用的下载和安装进度。

 GXDE 商店支持应用云同步。除安装本地应用之外，您还可以登录Deepin ID账号后，同步在其他设备上使用该账号新安装的应用，一键安装云端应用。


#### 安装本地应用

1. 在 GXDE 商店界面，点击应用的封面图， 进入该应用的详情界面。
...
除了通过启动器卸载应用（具体操作请参阅 [卸载应用](dman:///dde#卸载应用)），您还可以直接在 GXDE 商店进行卸载。
...
- 在 GXDE 商店登录Deepin ID后，您可以对应用进行评论或评分，但评论和评分必须同时提交才能成功。
...
### 登录
使用Deepin ID登录 GXDE 商店。

1. 在 GXDE 商店界面，点击标题栏上的头像登录。
2. 输入用户名/邮箱/手机号，和密码。
3. 点击 **登录**。
...
### 推荐应用
若您希望在 GXDE 商店上架某个应用，请推荐应用。
1. 在 GXDE 商店界面，点击 ![icon_menu](icon/icon_menu.svg)。
2. 点击 **推荐应用**。
...
### 帮助
点击“帮助”获取 GXDE 商店的帮助手册，让您进一步了解和使用 GXDE 商店。

1. 在 GXDE 商店界面，点击 ![icon_menu](icon/icon_menu.svg)。
2. 点击 **帮助**，查看 GXDE 商店的帮助手册。

### 关于
点击“关于”查看 GXDE 商店的版本介绍。

1. 在 GXDE 商店界面，点击 ![icon_menu](icon/icon_menu.svg)。
2. 点击 **关于**，查看 GXDE 商店的版本和介绍。


### 退出
您可以进入菜单栏点击退出 GXDE 商店。
