# GXDE 文件管理器|../common/deepin-file-manager.svg|

## 概述

GXDE 文件管理器是深度科技开发的一款功能强大、简单易用的文件管理工具。
...
您可以通过以下方式运行或关闭 GXDE 文件管理器，或者创建 GXDE 文件管理器的快捷方式。
...
3. 将鼠标指针置于 GXDE 文件管理器应用程序的图标上，右键单击 ![deepin-file-manager](icon/deepin-file-manager.svg)  图标，您可以：
 - 点击 **发送到桌面**，在桌面创建快捷方式。
...
- 在 GXDE 文件管理器界面点击  ![close_icon](icon/close_icon.svg) ，退出 GXDE 文件管理器。
- 在任务栏右键单击 ![deepin-file-manager](icon/deepin-file-manager.svg) ，选择 **关闭所有** 来退出 GXDE 文件管理器。
- 在 GXDE 文件管理器界面点击 ![icon_menu](icon/icon_menu.svg) ，选择 **退出** 来退出 GXDE 文件管理器。

## 主界面

 GXDE 文件管理器的主界面简单易用、功能全面，熟练的使用界面功能将使文件管理更加简单高效。
...
<table class="block1">
    ...
    <tbody>
    	...
    	<tr>
            <td>4</td>
            <td>菜单栏</td>
            <td>通过主菜单您可以新建窗口、切换深色主题、设置共享密码、设置 GXDE 文件管理器、查看帮助文档和关于信息、退出 GXDE 文件管理器。</td>
        </tr>
    		<tr>
            <td>5</td>
            <td>状态栏</td>
...
## 基本功能
 ...
 GXDE 文件管理器具备基本的文件管理功能，对文件(夹)进行新建、复制、重命名、删除等操作都非常简单。

### 新建文件(夹)

#### 新建文件

1. 在 GXDE 文件管理器界面上，点击鼠标右键。
2. 点击 **新建文档**。
3. 选择新建文件的类型。
4. 输入新建文件的名称。
...
## 常用操作
 ...
 GXDE 文件管理器具备很多特色功能，这些功能都是为了让文件管理更加简单、高效。
...
### 文件预览
 ...
 GXDE 文件管理器支持空格键预览功能，选中文件并按下键盘上的空格键就可以快速预览文件。预览窗口可以查看图片分辨率、文档大小、文本内容等，还支持gif、音频、视频播放。
...
1. 点击 GXDE 文件管理器导航栏上的 ![network_server_symbolic_normal_22px](icon/network_server_symbolic_normal_22px.svg) 图标。
2. 双击想要访问的网络文件。
3. 输入用户名密码或者匿名访问。
 - 未加密的网络文件可以匿名访问，不需要输入用户名和密码。
 - 加密的网络文件会弹出登陆框，输入账号和密码之后才能访问。如果在用户名密码提示框中勾选 **记住密码** ，再次访问不再需要密码。
...
## 磁盘管理
 ...
 GXDE 文件管理器可以管理本地和外接磁盘。

### 显示磁盘

您可以在 GXDE 文件管理器上的导航栏看到您的本地磁盘，当您挂载外接磁盘或者插入其他移动存储设备时，也可以在导航栏上看到相应的磁盘图标。
...
1. 在 GXDE 文件管理器计算机目录下，右键单击需要格式化的磁盘。
2. 选择 **格式化**。
...
1. 在 GXDE 文件管理器界面，点击 ![icon_menu](icon/icon_menu.svg)。
...
3. 调整自定义设置让您的文件管理器更顺手：
 ...
 - 设置  **对话框**，自定义是否使用 GXDE 文件管理器的文件选择对话框。
...
您可以点击“帮助”获取 GXDE 文件管理器的帮助手册，进一步了解和使用 GXDE 文件管理器。

1. 在 GXDE 文件管理器界面，点击  ![icon_menu](icon/icon_menu.svg) 。
2. 点击 **帮助**。
3. 查看 GXDE 文件管理器的帮助手册。


### 关于

您可以点击“关于”查看 GXDE 文件管理器的版本介绍。

1. 在 GXDE 文件管理器界面，点击  ![icon_menu](icon/icon_menu.svg) 。
2. 点击 **关于**。
3. 查看 GXDE 文件管理器的版本和介绍。


### 退出

您可以从菜单栏退出 GXDE 文件管理器。
